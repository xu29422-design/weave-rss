...
```javascript
var API_URL = 'http://localhost:3000';  // 本地测试地址
...
// 修改后（线上）
var API_URL = 'https://your-domain.com';
```
...
**本地**：`http://localhost:3000/api/digest/latest`  
**线上**：`https://your-domain.com/api/digest/latest`
